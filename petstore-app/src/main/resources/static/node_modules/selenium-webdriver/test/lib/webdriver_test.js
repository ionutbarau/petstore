...
describe('WebDriver', function () {
    ...
    describe('testAttachToSession', function () {
        it('sessionIsAvailable', function () {
            let executor = new FakeExecutor().expect(CName.DESCRIBE_SESSION).withParameters({'sessionId': SESSION_ID}).andReturnSuccess({'browserName': 'firefox'}).end();
        ...
        it('failsToGetSessionInfo', function () {
            let executor = new FakeExecutor().expect(CName.DESCRIBE_SESSION).withParameters({'sessionId': SESSION_ID}).andReturnError(ECode.UNKNOWN_ERROR, {'message': 'boom'}).end();
    ...
    describe('testCreateSession', function () {
        it('happyPathWithCapabilitiesHashObject', function () {
            ...
            }).andReturnSuccess({'browserName': 'firefox'}).end();
        ...
        it('happyPathWithCapabilitiesInstance', function () {
            let executor = new FakeExecutor().expect(CName.NEW_SESSION).withParameters({'desiredCapabilities': {'browserName': 'firefox'}}).andReturnSuccess({'browserName': 'firefox'}).end();
        ...
        it('failsToCreateSession', function () {
            let executor = new FakeExecutor().expect(CName.NEW_SESSION).withParameters({'desiredCapabilities': {'browserName': 'firefox'}}).andReturnError(ECode.UNKNOWN_ERROR, {'message': 'boom'}).end();
    ...
    it('testStopsCommandExecutionWhenAnErrorOccurs', function () {
        let executor = new FakeExecutor().expect(CName.SWITCH_TO_WINDOW).withParameters({'name': 'foo'}).andReturnError(ECode.NO_SUCH_WINDOW, {'message': 'window not found'}).end();

        var driver = executor.createDriver();
        driver.switchTo().window('foo');
        driver.getTitle();  // mock should blow if this gets executed

        return waitForAbort().then(expectedError(error.NoSuchWindowError, 'window not found'));
    });

    it('testCanSuppressCommandFailures', function () {
        let executor = new FakeExecutor().expect(CName.SWITCH_TO_WINDOW).withParameters({'name': 'foo'}).andReturnError(ECode.NO_SUCH_WINDOW, {'message': 'window not found'}).expect(CName.GET_TITLE).andReturnSuccess('Google Search').end();
    ...
    it('testErrbacksThatReturnErrorsStillSwitchToCallbackChain', function () {
        ...
        var driver = executor.createDriver();
        return driver.switchTo().window('foo').thenCatch(function () {
    ...
    it('testErrbacksThrownCanOverrideOriginalError', function () {
        let executor = new FakeExecutor().expect(CName.SWITCH_TO_WINDOW, {'name': 'foo'}).andReturnError(ECode.NO_SUCH_WINDOW, {'message': 'window not found'}).end();
    ...
    describe('nestedCommandFailures', function () {
        it('bubbleUpToGlobalHandlerIfUnsuppressed', function () {
            let executor = new FakeExecutor().expect(CName.GET_TITLE).expect(CName.SWITCH_TO_WINDOW, {'name': 'foo'}).andReturnError(ECode.NO_SUCH_WINDOW, {'message': 'window not found'}).end();
        ...
        it('canBeSuppressWhenTheyOccur', function () {
            let executor = new FakeExecutor().expect(CName.GET_TITLE).expect(CName.SWITCH_TO_WINDOW, {'name': 'foo'}).andReturnError(ECode.NO_SUCH_WINDOW, {'message': 'window not found'}).expect(CName.CLOSE).end();
        ...
        it('canBeCaughtAndSuppressed', function () {
            let executor = new FakeExecutor().expect(CName.GET_TITLE).expect(CName.GET_CURRENT_URL).expect(CName.SWITCH_TO_WINDOW, {'name': 'foo'}).andReturnError(ECode.NO_SUCH_WINDOW, {'message': 'window not found'}).expect(CName.CLOSE).end();
    ...
    describe('returningAPromise', function () {
        ...
        it('fromAnErrbackSuppressesTheError', function () {
            var count = 0;
            let executor = new FakeExecutor().expect(CName.SWITCH_TO_WINDOW, {'name': 'foo'}).andReturnError(ECode.NO_SUCH_WINDOW, {'message': 'window not found'}).expect(CName.GET_CURRENT_URL).andReturnSuccess('http://www.google.com').end();
    ...
    describe('executeScript', function () {
        ...
        it('scriptReturnsAnError', function () {
            let executor = new FakeExecutor().expect(CName.EXECUTE_SCRIPT).withParameters({
                ...
                'args': ['bam']
            }).andReturnError(ECode.UNKNOWN_ERROR, {'message': 'bam'}).end();
            var driver = executor.createDriver();
            return driver.executeScript('throw Error(arguments[0]);', 'bam').then(fail, function (e) {
                assertIsInstance(error.WebDriverError, e);
    ...
    describe('findElement', function () {
        it('elementNotFound', function () {
            let executor = new FakeExecutor().expect(CName.FIND_ELEMENT,
                {using: 'css selector', value: '*[id="foo"]'}).andReturnError(ECode.NO_SUCH_ELEMENT, {
        ...
        it('elementNotFoundInACallback', function () {
            let executor = new FakeExecutor().expect(CName.FIND_ELEMENT,
                {using: 'css selector', value: '*[id="foo"]'}).andReturnError(
                ECode.NO_SUCH_ELEMENT, {'message': 'Unable to find element'}).end();
            ...
            let executor = new FakeExecutor().expect(CName.FIND_ELEMENTS,
                {
                    using: 'css selector',
                    value: '*[id="foo"]'
                }).andReturnError(ECode.UNKNOWN_ERROR, {'message': 'There is no spoon'}).end();
    ...
    describe('alert handling', function () {
        it('interceptsAndTransformsUnhandledAlertErrors', function () {
            let executor = new FakeExecutor().expect(CName.FIND_ELEMENT,
                {using: 'css selector', value: '*[id="foo"]'}).andReturnError(ECode.UNEXPECTED_ALERT_OPEN, {
                'message': 'boom',
                'alert': {'text': 'hello'}
            }).end();
            ...
            let executor = new FakeExecutor().expect(CName.FIND_ELEMENT,
                {
                    using: 'css selector',
                    value: '*[id="foo"]'
                }).andReturnError(ECode.UNEXPECTED_ALERT_OPEN, {'message': 'boom'}).end();
    ...
    it('testWebElementCommansFailIfElementCouldNotBeFound', function () {
        let executor = new FakeExecutor().expect(CName.FIND_ELEMENT,
            {using: 'css selector', value: '*[id="foo"]'}).andReturnError(ECode.NO_SUCH_ELEMENT,
            {'message': 'Unable to find element'}).end();
    ...
    describe('actions()', function () {
        it('failsIfInitialDriverCreationFailed', function () {
            ...
            return new FakeExecutor().createDriver(session).actions().mouseDown().mouseUp().perform().thenCatch(assertIsStubError);
        });
    ...
    describe('touchActions()', function () {
        it('failsIfInitialDriverCreationFailed', function () {
            ...
            return new FakeExecutor().createDriver(session).touchActions().scroll({
                x: 3,
                y: 4
            }).perform().thenCatch(assertIsStubError);
        });
