...
test.suite(function (env) {
    ...
    test.ignore(env.browsers(Browser.PHANTOM_JS, Browser.IE, Browser.SAFARI)).describe('logging', function () {
        var driver;
        ...
        test.ignore(env.browsers(Browser.FIREFOX)).it('can be turned down', function () {
            var prefs = new logging.Preferences();
        ...
        // Firefox does not capture JS error console log messages.
        test.ignore(env.browsers(Browser.FIREFOX)).it('can be made verbose', function () {
            var prefs = new logging.Preferences();
        ...
        // Firefox does not capture JS error console log messages.
        test.ignore(env.browsers(Browser.FIREFOX)).it('clears records after retrieval', function () {
            var prefs = new logging.Preferences();
            prefs.setLevel(logging.Type.BROWSER, logging.Level.DEBUG);
