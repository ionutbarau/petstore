...
test.suite(function (env) {
    ...
    test.ignore(browsers(Browser.IPAD, Browser.IPHONE)).it('should wait for all frames to load in a frameset', function () {
    ...
    test.ignore(browsers(Browser.SAFARI)).it('should be able to navigate back in browser history', function () {
    ...
    test.ignore(browsers(Browser.SAFARI)).it('should be able to navigate back in presence of iframes', function () {
        driver.get(Pages.xhtmlTestPage);
    ...
    test.ignore(browsers(Browser.SAFARI)).it('should be able to navigate forwards in browser history', function () {
        driver.get(Pages.formPage);
    ...
    test.ignore(browsers(Browser.PHANTOM_JS)).it('should be able to refresh a page', function () {
        driver.get(Pages.xhtmlTestPage);
    ...
    test.ignore(browsers(
        ...
        Browser.OPERA,
        Browser.PHANTOM_JS,
        Browser.SAFARI)).it('should timeout if page load timeout is set', function () {
        driver.call(function () {
            driver.manage().timeouts().pageLoadTimeout(1);
            driver.get(Pages.sleepingPage + '?time=3').then(function () {
