...
describe('chrome.Options', function () {
    describe('fromCapabilities', function () {
        ...
        it('should extract supported WebDriver capabilities', function () {
            ...
            var logPrefs = {};
            var caps = webdriver.Capabilities.chrome().set(webdriver.Capability.PROXY, proxyPrefs).set(webdriver.Capability.LOGGING_PREFS, logPrefs);
    ...
    describe('toCapabilities', function () {
        ...
        it('sets generic driver capabilities', function () {
            var proxyPrefs = {};
            var loggingPrefs = {};
            var options = new chrome.Options().setLoggingPrefs(loggingPrefs).setProxy(proxyPrefs);
