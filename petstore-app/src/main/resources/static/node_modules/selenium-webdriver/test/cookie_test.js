...
test.suite(function (env) {
    ...
    describe('Cookie Management;', function () {
        ...
        test.ignore(env.browsers(Browser.IE)).it('only returns cookies visible to the current page', function () {
            var cookie1 = createCookieSpec();
            var cookie2 = createCookieSpec();
        ...
        test.ignore(env.browsers(Browser.ANDROID, Browser.FIREFOX, Browser.IE)).it('should retain cookie expiry', function () {
            var cookie = createCookieSpec();
