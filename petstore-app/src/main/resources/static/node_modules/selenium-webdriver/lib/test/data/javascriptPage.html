...
<div id="formageddon">
    <form action="#">
        ...
        <input id="clickField" type="text" onclick="document.getElementById('clickField').value='Clicked';"
               value="Hello"/>
        <input id="doubleClickField" type="text" onclick="document.getElementById('doubleClickField').value='Clicked';"
...
<div>
    ...
    <p><a id="updatediv" href="#" onclick="javascript:document.getElementById('dynamo').innerHTML = 'Fish and chips!';">Update
        a
        div</a></p>
</div>
...
<div>
    <form action="resultPage.html" id="on-form">
        ...
        <input id="changeable" name="changeable" onfocus="appendMessage('focus')" onchange="appendMessage('change')"
               onblur="appendMessage('blur')"/>
        ...
        <button type="button" id="jsSubmitButton" onclick="javascript:document.getElementById('on-form').submit();">
            Submitomatic
        </button>

        <button type="button" id="switchFocus" onclick="document.getElementById('theworks').focus();">Switch focus
        </button>
        <button type="button"
                onclick="var element = document.getElementById('switchFocus'); var clickEvent = document.createEvent('MouseEvents'); clickEvent.initMouseEvent('click', true, true, null, 0, 0, 0, 0, 0,false, false, false, false, 0, element);element.dispatchEvent(clickEvent);">
            Do magic
        </button>
        <br/>
        <label id="labelForCheckbox" for="labeledCheckbox" onclick="appendMessage('labelclick')">Toggle checkbox</label><input
            type="checkbox" id="labeledCheckbox" onclick="appendMessage('chboxclick')"/>
    </form>

    <form action="javascriptPage.html" id="submitListeningForm"
          onsubmit="appendMessage('form-onsubmit '); return false;">
        <p>
            <input id="submitListeningForm-text" type="text" onsubmit="appendMessage('text-onsubmit ')"
                   onclick="appendMessage('text-onclick ');"/>
            <input id="submitListeningForm-submit" type="submit" onsubmit="appendMessage('submit-onsubmit ')"
...
<a id="new_window" onmouseup="window.open('closeable_window.html', 'close_me')" href="#">Click me to open a new
    window</a>

<a id="throwing-mouseover" onmouseover="throw new Error()" href="#throwing-mouseover">Mouse over me will throw a JS
    error</a>
