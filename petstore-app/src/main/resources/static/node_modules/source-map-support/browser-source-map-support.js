...
(this.define || function (N, O) {
    ...
    (function p(v, l, b) {
        ...
        for (var k = "function" == typeof require && require, r = 0; r < b.length; r++)e(b[r]);
        return e
    })({
        1: [function (p,
                      v, l) {
        ...
        2: [function (p, v, l) {
            (function (b) {
                ...
                b.toByteArray = function (b) {
                    ...
                    var f = 0;
                    for (a = 0; a < h; a += 4)n = e(b.charAt(a)) << 18 | e(b.charAt(a + 1)) << 12 | e(b.charAt(a + 2)) << 6 | e(b.charAt(a + 3)), d((n & 16711680) >> 16), d((n & 65280) >> 8), d(n & 255);
                ...
                b.fromByteArray = function (b) {
                    var d, a = b.length % 3, h = "", n, e;
                    d = 0;
                    for (e = b.length - a; d < e; d += 3)n = (b[d] << 16) + (b[d + 1] << 8) + b[d + 2], n = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(n >>
                    ...
                    switch (a) {
                        ...
                        case 2:
                            n = (b[b.length - 2] << 8) +
                                b[b.length - 1], h += "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(n >> 10), h += "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(n >> 4 & 63), h += "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(n << 2 & 63), h += "="
                    }
                    return h
                }
        ...
        4: [function (p, v, l) {
            function b(g, m, c) {
                if (!(this instanceof b))return new b(g, m, c);
                var y = typeof g;
                if ("base64" === m && "string" === y)for (g = g.trim ?
                    g.trim() : g.replace(/^\s+|\s+$/g, ""); 0 !== g.length % 4;)g += "=";
                var a;
                if ("number" === y)a = A(g); else if ("string" === y)a = b.byteLength(g, m); else if ("object" === y)a = A(g.length); else throw Error("First argument needs to be a number, array or string.");
                var f;
                b._useTypedArrays ? f = b._augment(new Uint8Array(a)) : (f = this, f.length = a, f._isBuffer = !0);
                if (b._useTypedArrays && "number" === typeof g.byteLength)f._set(g); else {
                    var d = g;
                    if (L(d) || b.isBuffer(d) || d && "object" === typeof d && "number" === typeof d.length)for (m = 0; m < a; m++)b.isBuffer(g) ?
                        f[m] = g.readUInt8(m) : f[m] = g[m]; else if ("string" === y)f.write(g, 0, m); else if ("number" === y && !b._useTypedArrays && !c)for (m = 0; m < a; m++)f[m] = 0
                }
                return f
            }
            ...
            function e(g, m, c) {
                var y = "";
                for (c = Math.min(g.length, c); m < c; m++)y += String.fromCharCode(g[m]);
                return y
            }
            ...
            function k(g, m, c, a) {
                ...
                a = g.length;
                if (!(m >= a))return c ? (c = g[m], m + 1 < a && (c |= g[m + 1] << 8)) : (c = g[m] << 8, m + 1 < a && (c |= g[m +
                1])), c
            }
            ...
            function d(g, m, c, a) {
                a || (q("boolean" === typeof c, "missing or invalid endian"), q(void 0 !== m && null !== m, "missing offset"), q(m +
                    1 < g.length, "Trying to read beyond buffer length"));
                if (!(m >= g.length))return g = k(g, m, c, !0), g & 32768 ? -1 * (65535 - g + 1) : g
            }

            function a(g, m, c, a) {
                a || (q("boolean" === typeof c, "missing or invalid endian"), q(void 0 !== m && null !== m, "missing offset"), q(m + 3 < g.length, "Trying to read beyond buffer length"));
                if (!(m >= g.length))return g = r(g, m, c, !0), g & 2147483648 ? -1 * (4294967295 - g + 1) : g
            }
            ...
            function t(g, m, c, a, b) {
                ...
                var y = g.length;
                if (!(c >= y))for (b = 0, y = Math.min(y - c, 2); b < y; b++)g[c + b] = (m & 255 << 8 * (a ? b : 1 - b)) >>> 8 * (a ? b : 1 - b)
            }
            ...
            function c(g,
                ...
                var m = g.length;
                if (!(a >= m))for (f = 0, m = Math.min(m - a, 4); f < m; f++)g[a + f] = c >>> 8 * (b ? f : 3 - f) & 255
            }

            function f(g, c, a, b, f) {
                f || (q(void 0 !== c && null !== c, "missing value"), q("boolean" === typeof b, "missing or invalid endian"), q(void 0 !== a && null !== a, "missing offset"), q(a + 1 < g.length, "Trying to write beyond buffer length"),
                    z(c, 32767, -32768));
            ...
            function u(g, c, a, b, f) {
                f || (q(void 0 !== c && null !== c, "missing value"), q("boolean" === typeof b, "missing or invalid endian"), q(void 0 !==
                    a && null !== a, "missing offset"), q(a + 3 < g.length, "Trying to write beyond buffer length"), E(c, 3.4028234663852886E38, -3.4028234663852886E38));
            ...
            function x(g) {
                for (var c = [], a = 0; a < g.length; a++) {
                    var b = g.charCodeAt(a);
                    if (127 >= b)c.push(g.charCodeAt(a)); else {
                        var f = a;
                        55296 <= b && 57343 >= b && a++;
                        b = encodeURIComponent(g.slice(f, a + 1)).substr(1).split("%");
                        for (f =
                                 0; f < b.length; f++)c.push(parseInt(b[f], 16))
                    }
                }
                return c
            }
            ...
            function K(g) {
                for (var c = [], a = 0; a < g.length; a++)c.push(g.charCodeAt(a) & 255);
                return c
            }

            function B(g, c, a, b) {
                for (var m = 0; m < b && !(m + a >= c.length || m >= g.length); m++)c[m + a] = g[m];
                return m
            }
            ...
            b._useTypedArrays = function () {
                try {
                    var g = new ArrayBuffer(0), c = new Uint8Array(g);
                    c.foo = function () {
                        return 42
                    };
            ...
            b.concat = function (g, c) {
                ...
                if (0 === g.length)return new b(0);
                if (1 === g.length)return g[0];
                var a;
                if ("number" !== typeof c)for (a = c = 0; a < g.length; a++)c += g[a].length;
                var m = new b(c), f = 0;
            ...
            b.prototype.write = function (g, c, a, f) {
                if (isFinite(c))isFinite(a) || (f = a, a = void 0); else {
                    var m = f;
                    f = c;
                    c = a;
                    a = m
                ...
                switch (f) {
                    case "hex":
                        ...
                        a > f / 2 && (a = f / 2);
                        for (f = 0; f < a; f++)m = parseInt(g.substr(2 * f, 2), 16), q(!isNaN(m), "Invalid hex string"), this[c + f] = m;
                        b._charsWritten = 2 * f;
                        g = f;
                        break;
                    case "utf8":
            ...
            b.prototype.toString = function (g, c, a) {
                ...
                switch (g) {
                    case "hex":
                        ...
                        if (!c || 0 > c)c = 0;
                        if (!a || 0 > a || a > g)a = g;
                        for (g = ""; c < a; c++)g += C(this[c]);
                        a = g;
                        break;
                    case "utf8":
                    case "utf-8":
                        var f = g = "";
                        for (a = Math.min(this.length, a); c < a; c++)127 >= this[c] ? (g += F(f) + String.fromCharCode(this[c]),
                            f = "") : f += "%" + this[c].toString(16);
                        a = g + F(f);
                        break;
                    case "ascii":
                        a = e(this, c, a);
                    ...
                    case "utf-16le":
                        a = this.slice(c, a);
                        c = "";
                        for (g = 0; g < a.length; g += 2)c += String.fromCharCode(a[g] + 256 * a[g + 1]);
                        a = c;
                        break;
                    default:
                        throw Error("Unknown encoding");
            ...
            b.prototype.copy = function (g, c, a, f) {
                ...
                f || 0 === f || (f = this.length);
                c || (c = 0);
                if (f !== a && 0 !== g.length && 0 !== this.length)if (q(f >= a, "sourceEnd < sourceStart"), q(0 <= c && c < g.length, "targetStart out of bounds"), q(0 <= a && a < this.length, "sourceStart out of bounds"), q(0 <= f && f <= this.length, "sourceEnd out of bounds"), f > this.length && (f = this.length), g.length - c < f - a && (f = g.length - c + a), f -= a, 100 > f || !b._useTypedArrays)for (var m = 0; m < f; m++)g[m + c] = this[m + a]; else g._set(this.subarray(a, a + f), c)
            };
            b.prototype.slice =
                function (a, c) {
                    var g = this.length;
                    a = I(a, g, 0);
                    c = I(c, g, g);
                    if (b._useTypedArrays)return b._augment(this.subarray(a, c));
                    for (var g = c - a, f = new b(g, void 0, !0), m = 0; m < g; m++)f[m] = this[m + a];
                    return f
                };
            ...
            b.prototype.readUInt8 = function (a, c) {
                c || (q(void 0 !== a && null !==
                    a, "missing offset"), q(a < this.length, "Trying to read beyond buffer length"));
            ...
            b.prototype.readInt8 = function (a, c) {
                ...
                if (!(a >=
                    this.length))return this[a] & 128 ? -1 * (255 - this[a] + 1) : this[a]
            };
            ...
            b.prototype.fill = function (a, c, f) {
                ...
                q(f >= c, "end < start");
                if (f !== c && 0 !== this.length)for (q(0 <= c && c < this.length, "start out of bounds"), q(0 <= f && f <= this.length,
                    "end out of bounds"); c < f; c++)this[c] = a
            };
            b.prototype.inspect = function () {
                for (var a = [], c = this.length, f = 0; f < c; f++)if (a[f] = C(this[f]), f === l.INSPECT_MAX_BYTES) {
                    a[f + 1] = "...";
                    break
                }
            ...
            b.prototype.toArrayBuffer = function () {
                if ("undefined" !== typeof Uint8Array) {
                    ...
                    for (var a = new Uint8Array(this.length), c = 0, f = a.length; c < f; c += 1)a[c] = this[c];
                    return a.buffer
                }
        ...
        5: [function (p, v, l) {
            ...
            l.write = function (b, e, k, r, d, a) {
                var h,
                    n = 8 * a - d - 1, t = (1 << n) - 1, c = t >> 1, f = 23 === d ? Math.pow(2, -24) - Math.pow(2, -77) : 0;
                a = r ? 0 : a - 1;
                var G = r ? 1 : -1, u = 0 > e || 0 === e && 0 > 1 / e ? 1 : 0;
                e = Math.abs(e);
        ...
        6: [function (p, v, l) {
            (function (b) {
                ...
                function k(a, b) {
                    ...
                    for (var d = [], h = 0; h < a.length; h++)b(a[h], h, a) && d.push(a[h]);
                    return d
                }
                ...
                l.relative = function (a, b) {
                    ...
                    for (var h = d(a.split("/")), c = d(b.split("/")), f = Math.min(h.length, c.length), G = f, u = 0; u < f; u++)if (h[u] !== c[u]) {
                        G = u;
                        break
                    }
                    f = [];
                    for (u = G; u < h.length; u++)f.push("..");
        ...
        8: [function (p, v, l) {
            ...
            b.fromArray = function (e, d) {
                for (var a = new b, h = 0, n = e.length; h < n; h++)a.add(e[h],
                    d);
                return a
            };
            ...
            b.prototype.add = function (b, d) {
                var a = e.toSetString(b), h = k.call(this._set, a), n = this._array.length;
        ...
        9: [function (p, v, l) {
            ...
            l.encode = function (e) {
                ...
                do e = r & 31, r >>>= 5, 0 < r && (e |= 32), k += b.encode(e); while (0 < r);
                return k
            };
        ...
        12: [function (p, v, l) {
            ...
            var e = p("./util");
            b.prototype.unsortedForEach =
                function (b, e) {
                    this._array.forEach(b, e)
                };
            b.prototype.add = function (b) {
                var k = this._last, d = k.generatedLine, a = b.generatedLine, h = k.generatedColumn, n = b.generatedColumn;
        ...
        13: [function (p, v, l) {
            ...
            function e(k, l, d, a) {
                if (d < a) {
                    ...
                    for (var n = k[a], t = d; t < a; t++)0 >= l(k[t], n) && (h += 1, b(k, h, t));
                    b(k, h + 1, t);
                    h += 1;
                    e(k, l, d, h - 1);
                    e(k, l, h + 1, a)
        ...
        14: [function (p, v, l) {
            ...
            function e(a) {
                ...
                var b = d.getArg(c,
                    "sources"), u = d.getArg(c, "names", []), e = d.getArg(c, "sourceRoot", null), n = d.getArg(c, "sourcesContent", null), t = d.getArg(c, "mappings"), c = d.getArg(c, "file", null);
            ...
            function r(a) {
                ...
                this._sections = c.map(function (a) {
                    ...
                    var c = d.getArg(a, "offset"), f = d.getArg(c, "line"), u = d.getArg(c,
                        "column");
                    if (f < e.line || f === e.line && u < e.column)throw Error("Section offsets must be ordered and non-overlapping.");
                    e = c;
                    return {
                        generatedOffset: {generatedLine: f + 1, generatedColumn: u + 1},
            ...
            b.prototype.allGeneratedPositionsFor = function (c) {
                ...
                if (0 <= e) {
                    ...
                    if (void 0 === c.column)for (b = h.originalLine; h && h.originalLine === b;)u.push({
                        line: d.getArg(h, "generatedLine", null),
                        column: d.getArg(h, "generatedColumn", null),
                        lastColumn: d.getArg(h, "lastGeneratedColumn", null)
                    }), h = this._originalMappings[++e]; else for (c = h.originalColumn; h && h.originalLine === b && h.originalColumn == c;)u.push({
                        line: d.getArg(h, "generatedLine", null), column: d.getArg(h,
                            "generatedColumn", null), lastColumn: d.getArg(h, "lastGeneratedColumn", null)
            ...
            e.fromSourceMap = function (a) {
                var c = Object.create(e.prototype), b = c._names = h.fromArray(a._names.toArray(), !0), u = c._sources = h.fromArray(a._sources.toArray(), !0);
                ...
                for (var n = c.__generatedMappings = [], l = c.__originalMappings = [], r = 0, p = a.length; r < p; r++) {
                    var C = a[r], x = new k;
            ...
            Object.defineProperty(e.prototype, "sources", {
                get: function () {
                    return this._sources.toArray().map(function (a) {
                        return null !=
                        this.sourceRoot ? d.join(this.sourceRoot, a) : a
                    }, this)
                }
            });
            e.prototype._parseMappings = function (a, b) {
                for (var c = 1, f = 0, e = 0, h = 0, l = 0, r = 0, p = a.length, x = 0, v = {}, B = {}, F = [], H = [], z, E, q, D, J; x < p;)if (";" === a.charAt(x))c++, x++, f = 0; else if ("," === a.charAt(x))x++; else {
                    z = new k;
                    z.generatedLine = c;
                    for (D = x; D < p && !this._charIsMappingSeparator(a, D); D++);
                    E = a.slice(x, D);
                    if (q = v[E])x += E.length; else {
                        for (q = []; x < D;)n.decode(a, x, B), J = B.value, x = B.rest, q.push(J);
            ...
            e.prototype._findMapping = function (c,
                                                 b, d, e, h, n) {
                if (0 >= c[d])throw new TypeError("Line must be greater than or equal to 1, got " + c[d]);
                if (0 > c[e])throw new TypeError("Column must be greater than or equal to 0, got " + c[e]);
            ...
            e.prototype.computeColumnSpans = function () {
                for (var a = 0; a < this._generatedMappings.length; ++a) {
                    ...
                    b.lastGeneratedColumn =
                        Infinity
                }
            };
            e.prototype.originalPositionFor = function (a) {
                var c = {generatedLine: d.getArg(a, "line"), generatedColumn: d.getArg(a, "column")};
            ...
            e.prototype.sourceContentFor = function (a, b) {
                ...
                null != this.sourceRoot && (a = d.relative(this.sourceRoot,
                    a));
            ...
            e.prototype.generatedPositionFor = function (a) {
                ...
                if (!this._sources.has(c))return {line: null, column: null, lastColumn: null};
                c = this._sources.indexOf(c);
                c = {source: c, originalLine: d.getArg(a, "line"), originalColumn: d.getArg(a, "column")};
            ...
            Object.defineProperty(r.prototype, "sources", {
                get: function () {
                    for (var a = [], b = 0; b < this._sections.length; b++)for (var d = 0; d < this._sections[b].consumer.sources.length; d++)a.push(this._sections[b].consumer.sources[d]);
                    return a
                }
            });
            ...
            r.prototype.generatedPositionFor = function (a) {
                for (var c = 0; c < this._sections.length; c++) {
                    ...
                    if (-1 !==
                        b.consumer.sources.indexOf(d.getArg(a, "source"))) {
            ...
            r.prototype._parseMappings = function (a, b) {
                ...
                for (var c = 0; c < this._sections.length; c++)for (var f = this._sections[c], e = f.consumer._generatedMappings, h = 0; h < e.length; h++) {
                    var n =
        ...
        15: [function (p, v, l) {
            ...
            b.prototype._version = 3;
            b.fromSourceMap = function (a) {
                var d = a.sourceRoot, e = new b({file: a.file, sourceRoot: d});
                a.eachMapping(function (a) {
                    var c = {generated: {line: a.generatedLine, column: a.generatedColumn}};
            ...
            b.prototype.addMapping = function (a) {
                var b = k.getArg(a, "generated"), d = k.getArg(a, "original", null), e = k.getArg(a, "source", null);
                ...
                function (a, b, d) {
                    ...
                    this._mappings.unsortedForEach(function (b) {
                        if (b.source === e && null != b.originalLine) {
                            var n = a.originalPositionFor({line: b.originalLine, column: b.originalColumn});
                            null != n.source && (b.source = n.source, null != d && (b.source =
                                k.join(d, b.source)), null != c && (b.source = k.relative(c, b.source)), b.originalLine = n.line, b.originalColumn = n.column, null != n.name && (b.name = n.name))
                        }
                        n = b.source;
            ...
            b.prototype._validateMapping = function (a, b, d, e) {
                if (!(a && "line" in a && "column" in a && 0 < a.line &&
                    0 <= a.column && !b && !d && !e || a && "line" in a && "column" in a && b && "line" in b && "column" in b && 0 < a.line && 0 <= a.column && 0 < b.line && 0 <= b.column && d))throw Error("Invalid mapping: " + JSON.stringify({
                        generated: a,
                        source: d,
                        original: b,
                        name: e
            ...
            b.prototype._serializeMappings = function () {
                for (var a = 0, b = 1, d = 0, l = 0, c = 0, f = 0, r = "", u, p, I, A = this._mappings.toArray(), v = 0, C = A.length; v < C; v++) {
                    p = A[v];
                    u = "";
                    if (p.generatedLine !== b)for (a = 0; p.generatedLine !== b;)u += ";", b++; else if (0 < v) {
                        if (!k.compareByGeneratedPositionsInflated(p, A[v - 1]))continue;
                        u += ","
                    }
        ...
        16: [function (p, v, l) {
            ...
            b.prototype.prepend = function (b) {
                if (Array.isArray(b))for (var a =
                    b.length - 1; 0 <= a; a--)this.prepend(b[a]); else if (b.$$$isSourceNode$$$ || "string" === typeof b)this.children.unshift(b); else throw new TypeError("Expected a SourceNode, string, or an array of SourceNodes and strings. Got " + b);
                return this
            };
            ...
            b.prototype.join = function (b) {
                ...
                if (0 < e) {
                    a = [];
                    for (d = 0; d < e - 1; d++)a.push(this.children[d]), a.push(b);
            ...
            b.prototype.walkSourceContents = function (b) {
                for (var a =
                    0, d = this.children.length; a < d; a++)this.children[a].$$$isSourceNode$$$ && this.children[a].walkSourceContents(b);
                for (var e = Object.keys(this.sourceContents), a = 0, d = e.length; a < d; a++)b(k.fromSetString(e[a]), this.sourceContents[e[a]])
            };
            b.prototype.toString = function () {
                var b = "";
            ...
            b.prototype.toStringWithSourceMap = function (b) {
                var a = "", d = 1, k = 0, l = new e(b), c = !1, f = null, p = null, u = null, r = null;
                this.walk(function (b, e) {
                    a += b;
                    null !== e.source && null !== e.line && null !== e.column ? (f === e.source &&
                    p === e.line && u === e.column && r === e.name || l.addMapping({
                        source: e.source,
                        original: {line: e.line, column: e.column},
                        generated: {line: d, column: k},
                        name: e.name
                    }), f = e.source, p = e.line, u = e.column, r = e.name, c = !0) : c && (l.addMapping({
                        generated: {
                            line: d,
                            column: k
                        }
                    }), f = null, c = !1);
                    for (var h = 0, n = b.length; h < n; h++)10 === b.charCodeAt(h) ? (d++, k = 0, h + 1 === n ? (f = null, c = !1) : c && l.addMapping({
                        source: e.source,
                        original: {line: e.line, column: e.column},
                        generated: {line: d, column: k},
                        name: e.name
        ...
        17: [function (p, v, l) {
            ...
            function k(a) {
                ...
                a = l.isAbsolute(c);
                for (var c = c.split(/\/+/), h, k = 0, n = c.length - 1; 0 <= n; n--)h = c[n], "." ===
                h ? c.splice(n, 1) : ".." === h ? k++ : 0 < k && ("" === h ? (c.splice(n + 1, k), k = 0) : (c.splice(n, 2), k--));
                c = c.join("/");
                "" === c && (c = a ? "/" : ".");
            ...
            l.join = function (a, d) {
                ...
                var c = b(d), f = b(a);
                f && (a = f.path || "/");
                if (c && !c.scheme)return f && (c.scheme = f.scheme), e(c);
                if (c || d.match(t))return d;
            ...
            l.compareByGeneratedPositionsInflated = function (a, b) {
                ...
                c = a.generatedColumn - b.generatedColumn;
                if (0 !== c)return c;
                var c = a.source, d = b.source, c = c === d ? 0 : c > d ? 1 : -1;
                if (0 !== c)return c;
                c = a.originalLine - b.originalLine;
                if (0 !== c)return c;
                c = a.originalColumn - b.originalColumn;
        ...
        19: [function (p, v, l) {
            (function (b, e) {
                ...
                function u() {
                    ...
                    b.emit = function (c) {
                        if ("uncaughtException" === c) {
                            var d = arguments[1] && arguments[1].stack, e = 0 < this.listeners(c).length;
                            if (d && !e) {
                                d = arguments[1];
                ...
                var M = p("source-map").SourceMapConsumer, I = p("path"), A;
                try {
                    A = p("fs"), A.existsSync && A.readFileSync || (A = null)
                } catch (J) {
                }
                var L = !1, C = !1, x = !1, K = "auto", B = {}, F = {}, H = /^data:application\/json[^,]+base64,/, z = [], E = [],
                    q = r(z);
                z.push(function (a) {
                    a = a.trim();
                    if (a in B)return B[a];
                    var b = null;
                    if (A)A.existsSync(a) && (b = A.readFileSync(a, "utf8")); else {
                ...
                l.install = function (a) {
                    ...
                    !C && ("handleUncaughtExceptions" in a ?
                        a.handleUncaughtExceptions : 1) && "object" === typeof b && null !== b && "function" === typeof b.on && (C = !0, u())
                }
            }).call(this, p("node_modules/process/browser.js"), p("buffer").Buffer)
        }, {"node_modules/process/browser.js": 7, buffer: 4, fs: 3, module: 3, path: 6, "source-map": 18}]
    }, {}, [1]);
    return N
});
